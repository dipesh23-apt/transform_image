...
import (
	...
	"github.com/dipesh23-apt/transform_image/primitive"
)
...
func main() {
	...
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		<body>
			<h2 class="italic"> Transforming image using the Primitive package <br></h2>
...
func renderModeChoices(w http.ResponseWriter, r *http.Request, rs io.ReadSeeker, ext string) {
	...
	html := `<html><body>
			<h4>The transformed image in different shapes</h4>
			{{range .}}
